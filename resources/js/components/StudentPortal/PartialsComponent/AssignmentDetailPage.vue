        ...
        <v-card>
            ...
            <v-toolbar>
                <v-row>
                    <v-toolbar-title class="subheading ml-2">
                        <p>Semester 6 [Fall-17]</p>
                        <p>Course Code (CSI-302)</p>
                    </v-toolbar-title>

                    <v-divider class="mx-4" inset vertical></v-divider>

                    <!-- <v-toolbar-items class="">
                            <span class="marks text-centertext-center">
                                Define Constructor</span
                            >
            </v-toolbar-items>-->
                    <v-spacer></v-spacer>
                    <v-toolbar-items class="float-right setting">
            ...
            <v-container>
                <fieldset class="form-field-sets">
                    <legend class="form-field-set-name text-center">Instructions</legend>
                    <div class="instruction-block">
                        ...
                        <nav>
                            <ul>
                                ...
                                <li>
                                    All Types of plagiarism are strictly
                                    prohibited.
                                </li>
                                <li>
                                    This is a simple assignment so do not
                                    cheat.
                                </li>
                            </ul>
                        </nav>
