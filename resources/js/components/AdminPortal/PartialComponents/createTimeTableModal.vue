                ...
                <v-row>
                  ...
                  <v-col cols="12">
                    <v-select
                      ...
                      v-model="detailSchedule.subject"
                  ...
                  <v-col cols="6">
                    <v-select
                      :items="$store.state.teachers"
                      v-model="detailSchedule.teacher"
                  ...
                  <v-col cols="6">
                    <v-select
                      ...
                      v-model="detailSchedule.classRoom"
                      label="Select Class"
                    ></v-select>
                  </v-col>
                  <v-col cols="6">
