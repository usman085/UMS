<template>
  <div class="time-table-wrapper">
    ...
    <CourseOutlineViewModal :course="courseDetail" :courseDetailOutline="courseDetailOutline"></CourseOutlineViewModal>

    <AssignOutlineModal :course="courseDetail"></AssignOutlineModal>
  </div>
</template>
