                ...
                <v-dialog v-model="scheduleModalToggle" max-width="50%" persistent>
                    <v-card>
                        ...
                        <v-card-text>
                            <v-container>
                                <!-- Form Start -->
                                <v-form ref="form">   <!--Form Ref variable-->
                                <v-row>
                                    ...
                                    <v-menu
                                        ...
                                        :nudge-right="40"
                                        :return-value.sync="detailSchedule.startingtime"
                                    ...
                                    <v-text-field
                                        v-model="detailSchedule.startingtime"
                                    ...
                                    <v-time-picker
                                        ...
                                        v-model="detailSchedule.startingtime"
                                        full-width
                                       @click:minute="$refs.menu.save(detailSchedule.startingtime)"
                                    ></v-time-picker>
                                </v-menu>
                            </v-col>
                            ...
                            <v-col cols="6">
                                    <v-menu
                                        ...
                                        :close-on-content-click="false"
                                        :nudge-right="40"
                                        :return-value.sync="detailSchedule.endingTime"
                                        transition="scale-transition"
                                        offset-y
                                        max-width="290px"
                                        min-width="290px"
                                    ...
                                    <template v-slot:activator="{ on, attrs }">
                                    <v-text-field
                                        v-model="detailSchedule.endingTime"
                                    ...
                                    <v-time-picker
                                        v-if="endingTimeModal"
                                        v-model="detailSchedule.endingTime"
                                        full-width
                                       @click:minute="$refs.menu2.save(detailSchedule.endingTime)"
                                    ></v-time-picker>
                                </v-menu>
                            </v-col>
                                    ...
                                    <v-col cols="12">
                                        <div class="text-center">
                                            <v-btn color="primary" v-if="!updateBtn" @click.stop="insertTimeTable()">
                                                Add To Schedule 
                                            </v-btn>
                                             <v-btn color="primary" v-if="updateBtn" @click.stop="updateTableData()">
                                                Update the Schedule
                                            </v-btn>
                                            <v-btn color="red" class="cancel-btn" @click.stop="cancel()">
                                                Cancel 
                                            </v-btn>
                                        </div>  
                                    </v-col>
...
export default{
    ...
    computed:{
        ...
        detailSchedule:function(){ return {
